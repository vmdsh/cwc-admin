            ...
            <>
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input value={form.shop_name || ''} onChange={e => setForm(f => ({ ...f, shop_name: e.target.value }))} placeholder="Shop name" />
                </div>
                <div className="form-group">
                  <label>Club</label>
                  {isSuperAdmin
      ...
      {loading
        ...
        : (
          <div className="tbl-wrap">
            <table>
              <thead>
                <tr><th>Name</th><th>Club</th><th>Type</th><th>Contact</th><th>Actions</th></tr>
              </thead>
              <tbody>
                {rows.length === 0
                  ? <tr><td colSpan={5} style={{ textAlign: 'center', padding: '2rem', color: 'var(--text3)' }}>No shops yet.</td></tr>
                  : rows.map(r => (
                    <tr key={r.shop_id}>
